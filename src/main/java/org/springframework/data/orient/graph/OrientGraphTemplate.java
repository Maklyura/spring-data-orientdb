...
@Transactional
public class OrientGraphTemplate extends AbstractOrientOperations<Object> implements OrientObjectOperations {

    public OrientGraphTemplate(OrientObjectDatabaseFactory dbf) {
        super(dbf);
    }
    ...
    /*@Override
    public List<OEdge> command(String sql, Object... args) {
      System.out.println("GraphTemplateCommand!");
      return (List<OEdge>)((ODatabaseObject) dbf.db()).<List<OEdge>>objectCommand(sql, args);
    }*/
